    ...
    'implement' => [
        ...
        'roles' => [
            ...
            RolesEnum::BoxOffice->value => [
                ...
                'reservedTickets.view',
                'reservedTickets.viewDeleted',
                'reservedTickets.create',
        ...
        'permissions' => [
            ...
            'ticketTypes.view',
            'ticketTypes.viewDeleted',
            'ticketTypes.viewPending',
            'ticketTypes.create',
            'ticketTypes.update',
            'ticketTypes.delete',
            'ticketTypes.restore',
            'ticketTypes.forceDelete',
            'ticketTypes.*',

            'purchasedTickets.viewAny',
            'purchasedTickets.view',
            'purchasedTickets.viewDeleted',
            'purchasedTickets.create',
            'purchasedTickets.update',
            'purchasedTickets.delete',
            'purchasedTickets.restore',
            'purchasedTickets.forceDelete',
            'purchasedTickets.*',
            ...
            'reservedTickets.update',
            'reservedTickets.delete',
            'reservedTickets.restore',
            'reservedTickets.forceDelete',
